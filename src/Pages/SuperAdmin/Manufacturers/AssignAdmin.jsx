...
export default function AssignAdmin({ handleOk, companyId, setCompany }) {
    ...
    async function fetchUsers() {
        userAPI.getByRole('user/role', { genericName: 'ROLE_MANUFACTURING_COMPANY_ADMIN' }, 'firstName lastName email')
            .then(res => {
    ...
    async function assignAdmin() {
        adminAPI.assignAdmin('manufacture/assignAdmin', companyId, selectedAdmin)
            .then(res => {
                console.log(res)
    ...
    const steps = [
        ...
        },
        {
            ...
            content: <AddNewUser handleOk={handleOk} role='ROLE_MANUFACTURING_COMPANY_ADMIN' />,
        }
    ];
