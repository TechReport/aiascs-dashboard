...
export default function ProductRegistration() {
    const [reports] = useState({
        loading: false, data: [
            { createdAt: '12/10/2020', batch: 'batch 1', percentage: '7', count: '5000000' },
            { createdAt: '25/11/2020', batch: 'batch 2', percentage: '17', count: '5000000' },
            { createdAt: '21/12/2020', batch: 'batch 3', percentage: '7', count: '5000000' },
            { createdAt: '13/1/2020', batch: 'batch 4', percentage: '7', count: '5000000' },
            { createdAt: '17/2/2020', batch: 'batch 5', percentage: '7', count: '5000000' },
            { createdAt: '27/3/2020', batch: 'batch 6', percentage: '7', count: '5000000' },
            { createdAt: '7/4/2020', batch: 'batch 7', percentage: '7', count: '5000000' },
            { createdAt: '12/5/2020', batch: 'batch 8', percentage: '7', count: '5000000' },
            { createdAt: '2/6/2020', batch: 'batch 9', percentage: '7', count: '5000000' },
        ]
    })
                ...
                <div className="card-body" id='reportContents'>
                    <div className="titlebar d-flex justify-content-between">
                        ...
                        <div className="descriptions text-right">
                            <span className='h6'>Seed CO Company Limited</span><br />
                    ...
                    <div className="title mt-4">
                        <h6 className='mb-5 text-center h6 text-uppercase'>Re: <u>Product Registration Report for the year ending 31/12/2020.</u></h6>
                    ...
                    <div className="report-body">
                        <BootstrapTable trStyle={{ padding: '0px', cursor: 'pointer' }} data={reports.data} striped hover >
                            ...
                            <TableHeaderColumn dataField='createdAt' >Date Created</TableHeaderColumn>
